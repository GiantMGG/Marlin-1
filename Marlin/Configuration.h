...
/**MAX: To dos:
 * - add BL TOUCH as probe
 * - add TMC5130
 * - maybe change and check junction deviation
 * 
 * In configadvanced
...
#define STRING_CONFIG_H_AUTHOR "(MaxG, Ender-5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender Max"
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.22  // (mm) Distance from real junction edge      From above webpage 0.22
